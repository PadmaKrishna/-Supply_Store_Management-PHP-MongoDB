...
?>  
    <input type="label" value="Product Type" style="width:200px;"readonly>
    <select name="producttype" id="producttype" style="width:200px;" onchange="window.location='insert.php?prod_type='+this.value">
...
<center>    <div class="container">
    ...
    <center>    <input type="submit" value="Insert" name="submit_mobile"></center>
</div>
    <?php
   }
...
<center>    <div class="container">
    ...
    <input type="label" value="Quantity" style="width:200px;"readonly>
    <input type="text" name="qty" style="width:200px;"><br>
    <center>    <input type="submit" value="Insert" name="submit_LED"></center>
</div>
    <?php
   }
...
<center>    <div class="container">
    ...
    <input type="label" value="Quantity" style="width:200px;"readonly>
    <input type="text" name="qty" style="width:200px;"><br>
    <center>    <input type="submit" value="Insert" name="submit_LCD"></center>
</div>
    <?php
   }
...
<center>    <div class="container">
    ...
    <input type="label" value="Quantity" style="width:200px;"readonly>
    <input type="text" name="qty" style="width:200px;"><br>
    <center>    <input type="submit" value="Insert" name="submit_laptop"></center>
    </div>
    <?php
   }
?>
